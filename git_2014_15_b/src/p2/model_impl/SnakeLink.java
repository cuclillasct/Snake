...
public class SnakeLink extends AGameObject {
	
	public SnakeLink(){}
	
	public SnakeLink(String id, String name, int value, Coordinate pos){
		super(id, name, value, pos);
	}
	
	public SnakeLink(JSONObject jsonObj) throws JSONException, ParamException {
		super(jsonObj);
	}
	
	public SnakeLink(String str_snake_link) throws JSONException, ParamException{
	...
	public static void main(String [] args) throws JSONException, ParamException{
		System.out.println("SankeLink.main.Testing class SnakeLink");
		for (int i = 0; i < 10; i++){
			SnakeLink c = new SnakeLink("SN_id_"+i,"SN_name_"+ i, (i%2 == 0)?i:-i , new Coordinate(i, i) );
			System.out.println(c);
			JSONObject json = c.toJSONObject();
			System.out.println(json);
			System.out.println(new SnakeLink(json));
			System.out.println("-------------------------------------");
		}
	}
}
